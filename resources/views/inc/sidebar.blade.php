            ...
            <ul class="list-unstyled menu-categories" id="topAccordion">
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="menu1" data-parent="#topAccordion">
                        <li class="{{ ($config['page_name'] === 'cadastrar-empresa') ? 'active' : '' }}">
                            <a href="/empresa"> Cadastrar </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="menu2" data-parent="#topAccordion">
                        <li class="{{ ($config['page_name'] === 'cadastrar-profissional') ? 'active' : '' }}">
                            <a href="/profissional"> Cadastrar</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="menu1" data-parent="#topAccordion">
                        <li class="{{ ($config['page_name'] === 'config-geral') ? 'active' : '' }}">
