            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                        <input type="hidden" id="email-user" value="{{ Auth::user()->email }}">
                        <input type="hidden" value="{{ Auth::user()->perfil }}" id="perfil-user">
                        <input type="hidden" id="url-perfil" value="{{ Request::url() }}">
                                    ...
                                    <form action="" method="PUT">
                                        ...
                                        <input type="hidden" id="email_verified">
                                                ...
                                                <div class="form-row mb-1">
                                                    ...
                                                    <button type="button" class="btn btn-primary mt-3" id="editar-dados-profissional">Confirmar</button>
                                                </div>
                                ...
                                <form action="" method="PUT">
                                    ...
                                    <input type="hidden" id="email_verified">
                                            ...
                                            <div class="form-row mb-1">
                                                ...
                                                <button type="button" class="btn btn-primary mt-3" data-dismiss="modal" id="editar-dados-empresa">Confirmar</button>
                                            </div>
